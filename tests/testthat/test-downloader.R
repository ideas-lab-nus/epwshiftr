...
test_that("FileDownloader preflights disk requirements", {
    ...
    # Keep the blocking threshold far above normal free-space jitter reported by
    # platform-specific disk tools, especially on Windows CI runners.
    impossible_reserve <- free + 1024^4
    ...
    blocker <- FileDownloader$new(
        ...
        resource_policy = list(min_free_space = impossible_reserve),
        n_workers = 0L
    )
