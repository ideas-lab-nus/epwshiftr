...
JSON file named `CMIP6DICT.json` in the specified folder. It returns the full
...
current `EsgDict` object. It reads the JSON file named `CMIP6DICT.json` and loads
