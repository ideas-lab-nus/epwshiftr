...
for (path in schema_files) {
    ...
    # Source schemas need their reusable definitions promoted once; checked-in
    # schemas already carry those definitions and must stay stable.
...
# Standalone query-response persistence shares the same Solr document contract
