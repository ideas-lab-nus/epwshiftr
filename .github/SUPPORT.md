# Getting help with epwshiftr

Thanks for using epwshiftr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/epwshiftr/issues) to make sure the 
