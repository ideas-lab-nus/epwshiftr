...
The older data.table-oriented workflow remains documented in the reference for
compatibility, but new work should migrate to the store-native API. This article
maps old concepts to new ones.
