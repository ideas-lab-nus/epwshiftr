...
The recommended user call selects original morphing as a reusable monthly
transformation and gives the run an explicit matching historical CMIP6
reference. A transform
contains calculation settings only; the site, model, periods, reference, and
output directory remain execution inputs.
