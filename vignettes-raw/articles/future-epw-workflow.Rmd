...
This article uses the default Belcher recipe. It is a change-factor backend, so
...
For Belcher change-factor morphing, pass either an extracted historical
`ShiftClimate` stage or an automatic reference spec such as
